...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2023 at 03:38 PM
...
(36, 'PS-00007', 'OB-00106 ', '2023-08-06', 30, 'Aisyah'),
(37, 'PS-00001', 'OB-00139 ', '2023-08-23', 5, 'Apoteker');
...
(124, 'OB-00139 ', '2023-08-12', '2024-08-12', 10, 'Yudhistira Ilham');
...
('PS-00009', 'Joko Wahyuni', 'Serengan', '99887657');
...
(1, 'admin', 'admin@gmail.com', '$2y$10$T8BTys3bkw8TmAhWAwr8aONG/2vxD7eMPAAmO46Rvo1vltFRft3Iu', 1, 1),
(2, 'Apoteker', 'apoteker@gmail.com', '$2y$10$FEYEDR9usbWDLHFV.fXrVOSda87/XGMNeAbnTaHb7F3lNVoKUqq9q', 2, 1),
(6, 'syamsudin', 'syamsudin@gmail.com', '$2y$10$.tlr1KNNGNKp21WzLpBHceCT1jHK3youmk18e8J7DYNyqX0MmtGES', 2, 0),
(7, 'Pendaftaran', 'pendafatran@gmail.com', '$2y$10$FEYEDR9usbWDLHFV.fXrVOSda87/XGMNeAbnTaHb7F3lNVoKUqq9q', 4, 1);
...
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `sort_menu`, `title`, `url`, `icon`, `is_active`) VALUES
(1, 1, 1, 'Dashboard', 'admin', 'fas fa-fw fa-tachometer-alt', 1),
(2, 1, 3, 'Obat', 'obat', 'fas fa-fw fa-tablets', 1),
(3, 1, 2, 'Pasien', 'pasien', 'fas fa-fw fa-chalkboard-teacher', 1),
(4, 2, 1, 'Dashboard', 'user', 'fas fa-fw fa-tachometer-alt', 1),
(5, 1, 7, 'Config User', 'admin/user', 'fas fa-fw fa-users-cog', 1),
(6, 2, 3, 'Obat Masuk', 'obatmasuk', 'fas fa-fw fa-external-link-alt', 1),
(7, 2, 2, 'Data Obat', 'dataobat', 'fas fa-fw fa-tablets', 1),
(8, 1, 4, 'Obat Keluar', 'obatkeluar', 'fas fa-fw fa-outdent', 1),
(9, 1, 8, 'Change Password', 'admin/changepassword', 'fas fa-fw fa-user-edit', 1),
(10, 2, 6, 'Change Password', 'user/changepassword', 'fas fa-fw fa-user-edit', 1),
(11, 1, 6, 'Obat Kadaluarsa', 'kadaluarsa', 'fas fa-fw fa-shipping-fast', 1),
(12, 1, 9, 'Laporan Pasien', 'admin/lap_pasien', 'fas fa-fw fa-print', 1),
(13, 2, 7, 'Laporan Obat Masuk', 'user/lap_obatmasuk', 'fas fa-fw fa-print', 1),
(14, 1, 10, 'Laporan Obat Keluar', 'admin/lap_obatkeluar', 'fas fa-fw fa-print', 1),
(15, 1, 13, 'Laporan Persediaan', 'admin/lap_persediaan', 'fas fa-fw fa-print', 1),
(16, 1, 14, 'Laporan Stok FIFO', 'admin/lap_stok', 'fas fa-fw fa-print', 1),
(17, 1, 12, 'Laporan Kadaluarsa', 'admin/lap_kadaluarsa', 'fas fa-fw fa-print', 1),
(18, 1, 5, 'Obat Masuk', 'obatmasuk', 'fas fa-fw fa-external-link-alt', 1),
(19, 1, 11, 'Laporan Obat Masuk', 'admin/lap_obatmasuk', 'fas fa-fw fa-print', 1),
(20, 2, 4, 'Obat Keluar', 'obatkeluar', 'fas fa-fw fa-outdent', 1),
(21, 2, 5, 'Obat Kadaluarsa', 'kadaluarsa', 'fas fa-fw fa-shipping-fast', 1),
(22, 2, 8, 'Laporan Obat Keluar', 'user/lap_obatkeluar', 'fas fa-fw fa-print', 1),
(23, 2, 9, 'Laporan Persediaan', 'user/lap_persediaan', 'fas fa-fw fa-print', 1),
(24, 4, 2, 'Pasien', 'pasien', 'fas fa-fw fa-chalkboard-teacher', 1),
(25, 4, 1, 'Dashboard', 'user', 'fas fa-fw fa-tachometer-alt', 0),
(26, 4, 4, 'Laporan Pasien', 'user/lap_pasien', 'fas fa-fw fa-print', 1),
(27, 4, 3, 'Change Password', 'user/changepassword', 'fas fa-fw fa-user-edit', 1);
...
--
ALTER TABLE `obatkeluar`
  MODIFY `id_obatkeluar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `obatmasuk`
--
ALTER TABLE `obatmasuk`
  MODIFY `id_obatmasuk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
